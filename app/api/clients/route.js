...
export async function POST(req) {
  try {
    ...
    if (existingClient && gstNumber && gstNumber !== "" && gstNumber !== "N/A") {
    ...
    // 4. Handle Cloudinary Upload with Graceful Error Handling
    if (file && file !== "null" && typeof file !== "string") {
      try {
        ...
        // Fallback gracefully without blocking client creation
      }
    }
